...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Password (2)'), '123456', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - LOGIN'), 1000)

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView'), 1000)

Mobile.scrollToText('10')
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - 0'), '0365819523', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - BC'), 'KTX', 0)

...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Email (1)'), Email, 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Password (1)'), Password, 0)
